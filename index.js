...
const init=()=>{
    ...
    c.height=h;
    ctx=c.getContext("2d");
    sanitizer=document.getElementById("sanitizer");
    posY=w/2;
    speed=0;
    speedX=5;
    sanitizer.style.top=posY+"px";
    virusImg= new Image();
...
const updateLost=()=>document.getElementsById("lost")[0].innerText=lost;
const updateKill=()=>document.getElementsById("kill")[0].innerText=kill;
const updateLife=()=>document.getElementsById("life")[0].innerText=life+"%";
const geTime=()=>{
    cptTime--;
    document.getElementById("time")[0].innerText=cptTime;
};
const down=()=>{
    speed=2;
    sanitizer.style.transform="rotate(3deg)";
};
const up=()=>{
    speed=-4;
    sanitizer.style.transform=  "rotate(-3deg)";
...
const stop=()=>{
    speed=0;
    sanitizer.style.transform= "rotate(0)";
};
...
const checkSanitizer=()=>{
    ...
    if(posY>h-105)
        sanitizer.style.transform="rotate(0)";
        sanitizer.style.top=posY + "px";
        sanitizer.style.left=speedX + "px";
};
const checkVirus=()=>{
 ...
 const end =()=>{
     ...
     if (life>0 && speedX<=10)
     {
         setTimeout(function(){
             ...
             document.getElementById("state").style.innerText="Congrates....!";
         ...
         {
            document.getElementById("finsih").style.display="flex";
   ...
   const lose =()=>{
       ...
       const retry =()=>{
           ...
           updateKill();
           updateLife();
           document.getElementById('finsih').style.display='none';
       };
       const signalDead=()=>{
